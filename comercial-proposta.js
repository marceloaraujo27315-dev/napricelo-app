const DADOS_NAPRICELO={cnpj:'62.660.498/0001-76',inscricao_estadual:'005.306.466.0098',cidade:'Araxá – MG',telefone:'(34) 3611-0223',email:'napricelocontato@gmail.com'};
...
async function gerarPropostaComercial(id){
  ...
  <div class="aceite"><div><div class="assin">Napricelo Soluções Ambientais<br>CNPJ ${DADOS_NAPRICELO.cnpj}</div></div><div><div class="assin">Aceite do cliente<br>${escHtml(o.cliente||'')}</div></div></div>
  <div class="rodape"><span>Napricelo Soluções Ambientais • CNPJ ${DADOS_NAPRICELO.cnpj} • IE ${DADOS_NAPRICELO.inscricao_estadual}</span><span>${escHtml(o.numero||'')}</span></div><div class="acoes"><button onclick="window.print()">Imprimir / Salvar em PDF</button></div></body></html>`);w.document.close();
}
